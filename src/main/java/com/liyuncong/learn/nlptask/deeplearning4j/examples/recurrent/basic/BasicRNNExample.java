package com.liyuncong.learn.nlptask.deeplearning4j.examples.recurrent.basic;
...
public class BasicRNNExample {
	...
	private static final char[] LEARNSTRING = "*liyuncong and wangfang.".toCharArray();
	...
	public static void main(String[] args) {
		...
		// 每个SAMPLE是一句话，每一行对应一个字符，每一列对应一个位置，某列某列为1，表示这个位置上的是这个字符
