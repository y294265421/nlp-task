...
/** This is a DataSetIterator that is specialized for the IMDB review dataset used 
 * in the Word2VecSentimentRNN example
 * It takes either the train or test set data from this data set, plus a WordVectors 
 * object (typically the Google News
 * 300 pretrained vectors from https://code.google.com/p/word2vec/) and generates 
