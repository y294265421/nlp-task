package com.liyuncong.learn.nlptask.deeplearning4j.examples.recurrent.word2vecsentiment;
...
import com.liyuncong.learn.nlptask.deeplearning4j.examples.utilities.DataUtilities;

import java.io.*;
import java.net.URL;

/**Example: Given a movie review (raw text), classify that movie review as either 
 * positive or negative based on the words it contains.
 * This is done by combining Word2Vec vectors and a recurrent neural network model. 
 * Each word in a review is vectorized
...
public class Word2VecSentimentRNN {
    ...
    public static final String WORD_VECTORS_PATH = "dl4j/GoogleNews-vectors-negative300.bin.gz";
    ...
    public static void main(String[] args) throws Exception {
        ...
        int truncateReviewsToLength = 8;  //Truncate reviews with length (# words) greater than this
