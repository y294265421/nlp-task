package com.liyuncong.learn.nlptask.deeplearning4j.examples.feedforward.classification;
...
public class MLPClassifierMoon {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSetIterator testIter = new RecordReaderDataSetIterator(rrTest,2,0,2);
