...
//		String serializedClassifier = "classifiers/english.all.3class.distsim.crf.ser.gz";
		...
		if (args.length > 1) {
			...
			/*
			 * For the file, it shows (1) how to run NER on a String, (2) how to
			 * get the entities in the String with character offsets, and (3)
			 * how to run NER on a whole file (without loading it into a
			 * String).
			 */
			...
			// -- This code prints out the first order (token pair) clique
			// probabilities.
			// -- But that output is a bit overwhelming, so we leave it
			// commented out by default.
			// System.out.println("---");
			// System.out.println("First Order Clique Probabilities");
			// ((CRFClassifier) classifier).printFirstOrderProbs(args[1],
			// readerAndWriter);
			 ...
			 * sentence, and how to do this and produce several formats,
			 * including slash tags and an inline XML output format. It also
			 * shows the full contents of the {@code CoreLabel}s that are
			 * constructed by the classifier. And it shows getting out the
			 * probabilities of different assignments and an n-best list of
			 * classifications with probabilities.
			 */
			...
			for (String str : example) {
				...
				// The first column gives entities, the second their classes,
				// and the third the remaining text in a document
